...
public interface TagGiftCertificateRepository {
     ...
     */
    int createTagGiftCertificate(long certificateId, long tagId);
     ...
     */
    List<Long> getAllTagsIdByGiftCertificate(long certificateId);
     ...
     */
    List<Long> getAllCertificateIdByTag(long tagId);
}
